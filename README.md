...
Proyecto educativo desarrollado en **Unity**, enfocado en la creación de un **videojuego de plataformas 2D**.  
Incluye tutoriales, prácticas, documentación técnica y el producto final del videojuego.
...
6. [Créditos de la Plantilla Web](#-créditos-de-la-plantilla-web)
7. [Autores](#-autores)
